...
This conceptual design was completed while I was working as a part-time landscape architecture assistant at **Shanghai Xian Dai Architectural Design (Group) Co., Ltd.**

The MICSON Roof Garden Landscape Concept transforms an underused industrial rooftop into a vibrant social and cultural platform that reflects the company’s values while improving the daily experience of employees. The existing roof is a large, flat concrete surface partly occupied by photovoltaic panels, with wide open exposure to sun and sky and long views across the surrounding urban fabric. This simple yet expansive structural grid provides both the technical base and design opportunity for a clear, legible landscape framework.

<figure>
  <img src="./proj6_weisong/P1.png" alt="Design Plan" width="850">
...
<figure>
  <img src="./proj6_weisong/P2.png" alt="Design Plan" width="850">
  <figcaption>Figure 2. Site Plan.</figcaption>
</figure>

<figure>
  <img src="./proj6_weisong/P3.png" alt="Design Plan" width="850">
...
<figure>
  <img src="./proj6_weisong/P4.png" alt="Design Plan" width="850">
...
<figure>
  <img src="./proj6_weisong/P8.png" alt="Design Plan" width="850">
  <figcaption>Figure 5. Hand Drawing Draft of the Spatial Contrast.</figcaption>
</figure>
...
<figure>
  <img src="./proj6_weisong/P5.png" alt="Design Plan" width="850">
  <figcaption>Figure 6. Perspective.</figcaption>
</figure>

<figure>
  <img src="./proj6_weisong/P61.png" alt="Design Plan" width="850">
  <figcaption>Figure 7. Perspective.</figcaption>
</figure>
...
<figure>
  <img src="./proj6_weisong/P7.png" alt="Design Plan" width="850">
  <figcaption>Figure 8. Bird Eye View.</figcaption>
</figure>
